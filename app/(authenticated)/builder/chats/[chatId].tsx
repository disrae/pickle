...
export default function BuilderChatScreen() {
    ...
    const chat = useQuery(
        api.builderChats.get,
        chatId ? { chatId: chatId as Id<"builderChats"> } : "skip"
    );
    const messages = useQuery(
        api.builderChatMessages.list,
        chatId ? { chatId: chatId as Id<"builderChats"> } : "skip"
    );

    const sendMessage = useMutation(api.builderChatMessages.send);
    const toggleNotifications = useMutation(api.builderChats.toggleNotifications);
    const deleteChat = useMutation(api.builderChats.deleteChat);
    ...
    const handleToggleNotifications = async () => {
        ...
        try {
            await toggleNotifications({ chatId: chatId as Id<"builderChats"> });
        } catch (error) {
        ...
        Alert.alert(
            ...
            [
                { text: "Cancel", style: "cancel" },
                {
                    ...
                    onPress: async () => {
                        try {
                            await deleteChat({ chatId: chatId as Id<"builderChats"> });
                            router.back();
                        } catch (error) {
    ...
    const handleSend = async () => {
        ...
        try {
            await sendMessage({
                chatId: chatId as Id<"builderChats">,
