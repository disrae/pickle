                                ...
                                <View className="bg-white rounded-3xl p-6 w-full max-w-md" style={{ minWidth: 320 }}>
                                    <View className="flex-row items-center justify-between mb-6">
                                        ...
                                        <TouchableOpacity onPress={handleClose} disabled={isCreating}>
                                            <Ionicons name="close" size={28} color="#5c6454" />
                                        </TouchableOpacity>
                                    </View>
                                    ...
                                    <View className="mb-4">
                                        ...
                                        <TextInput
                                            ...
                                            className="bg-surface-2 rounded-xl px-4 py-3 text-foreground text-base"
                                    ...
                                    <View className="flex-row gap-3">
                                        <TouchableOpacity
                                            onPress={handleClose}
                                            className="flex-1 bg-surface-2 rounded-xl py-3 items-center"
                                            disabled={isCreating}
                                        >
