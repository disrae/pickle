...
export function DrillDetailModal({
    ...
    const completeMilestone = useMutation(api.drillProgress.completeMilestone);
    ...
    const handleToggleMilestone = async (index: number) => {
        ...
        try {
            await completeMilestone({ drillId, milestoneIndex: index });
        } catch (error) {
                            ...
                            {drill.milestones.map((milestone, index) => {
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        className={`flex-row items-center p-4 rounded-xl mb-2 ${isCompleted ? "bg-lime-50 border-2 border-lime-400" : "bg-slate-50"}`}
                                    >
                                        <View
